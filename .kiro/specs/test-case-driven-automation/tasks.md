...
- [ ] 1. Data Model Foundation and Migration
...
- [ ] 1.1 Extend Python data models for step-based scripts
...
- [ ] 1.2 Write property test for script structure validation
  - **Property 1: Test Script Structure Validation**
  - **Validates: Requirements 1.1, 1.2, 1.5**

- [ ] 1.3 Implement legacy script migration logic
...
- [ ] 1.4 Write property test for migration correctness
  - **Property 16: Legacy Migration Correctness**
  - **Validates: Requirements 6.1, 6.2, 6.3, 6.4**

- [ ] 1.5 Add TypeScript interfaces for frontend step management
...
- [ ] 1.6 Write property test for data persistence architecture
  - **Property 18: Data Persistence Architecture**
  - **Validates: Requirements 8.1, 8.2, 8.5**

- [ ] 2. Recording Engine Integration
...
- [ ] 2.1 Extend recorder to support step-based action mapping
...
- [ ] 2.2 Write property test for step recording behavior
  - **Property 2: Step Recording Behavior**
  - **Validates: Requirements 2.1, 2.2, 2.5**

- [ ] 2.3 Implement action insertion within existing steps
...
- [ ] 2.4 Write property test for action insertion preservation
  - **Property 4: Action Insertion Preservation**
  - **Validates: Requirements 2.4**

- [ ] 2.5 Update IPC bridge for step-based recording commands
...
- [ ] 3.1 Create TestStepPlanner component (left pane)
...
- [ ] 3.2 Write property test for step reordering consistency
  - **Property 3: Step Reordering Consistency**
  - **Validates: Requirements 1.3**

- [ ] 3.3 Create ActionCanvas component (right pane)
...
- [ ] 3.4 Write property test for step selection filtering
  - **Property 6: Step Selection Filtering**
  - **Validates: Requirements 4.2**

- [ ] 3.5 Write property test for action-step isolation
  - **Property 5: Action-Step Isolation**
  - **Validates: Requirements 4.4**

- [ ] 3.6 Integrate dual-pane editor with existing ScriptEditorScreen
...
- [ ] 5.1 Extend AIVisionCaptureAction with assertion support
...
- [ ] 5.2 Write property test for assertion action behavior
  - **Property 7: Assertion Action Behavior**
  - **Validates: Requirements 3.1**

- [ ] 5.3 Write property test for evidence collection
  - **Property 10: Evidence Collection**
  - **Validates: Requirements 3.5**

- [ ] 5.4 Implement assertion result processing
...
- [ ] 5.5 Write property test for assertion result handling
  - **Property 8: Assertion Result Handling**
  - **Validates: Requirements 3.2, 3.3**

- [ ] 5.6 Add multiple assertion logic for test steps
...
- [ ] 5.7 Write property test for multiple assertion logic
  - **Property 9: Multiple Assertion Logic**
  - **Validates: Requirements 3.4**

- [ ] 6. Step-Based Execution Engine
...
- [ ] 6.1 Extend Player class for step-based execution
...
- [ ] 6.2 Write property test for execution flow management
  - **Property 11: Execution Flow Management**
  - **Validates: Requirements 5.1, 5.2, 7.4**

- [ ] 6.3 Implement failure cascade and continue-on-failure logic
...
- [ ] 6.4 Write property test for continue on failure
  - **Property 12: Continue on Failure**
  - **Validates: Requirements 7.1**

- [ ] 6.5 Write property test for conditional execution
  - **Property 14: Conditional Execution**
  - **Validates: Requirements 7.5**

- [ ] 6.6 Create business-language test report generator
...
- [ ] 6.8 Write property test for report separation
  - **Property 19: Report Separation**
  - **Validates: Requirements 8.3**

- [ ] 7. Advanced Step Management Features
...
- [ ] 7.1 Implement step merging functionality
...
- [ ] 7.2 Write property test for step merging preservation
  - **Property 13: Step Merging Preservation**
  - **Validates: Requirements 7.2**

- [ ] 7.3 Add step splitting capabilities
...
- [ ] 7.4 Implement session state isolation
...
- [ ] 7.5 Write property test for session state isolation
...
- [ ] 8.1 Update script storage service for step-based scripts
...
- [ ] 8.2 Write property test for format compatibility
...
- [ ] 9.1 End-to-end workflow validation
